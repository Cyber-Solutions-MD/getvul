...
- **BL-06 — Safari.app severity-glyph legibility (HUMAN).** ✅ **DONE (2026-07-15).** Igor confirmed all five glyphs (■ ▲ ◆ ○ □) render distinct + legible at 14px in real macOS Safari.app on `/dashboard/vulnerabilities` + drill panel. Recorded in `15-HUMAN-UAT.md` Item 1 (phase 15 human UAT now 3/3 verified).
