# Requirements (DRAFT): GetVul v5.0 — Close the Loop: Remediation Orchestration & Assurance

> **📋 DRAFT STUB — not started.** Companion to [v5.0-PROPOSAL.md](v5.0-PROPOSAL.md). These
> requirements are proposed, not committed. Finalize (IDs, wording, phase numbers) at activation
> via `/gsd-new-milestone` **after v4.0 ships**. All items intentionally `[ ]` Pending.

**Drafted:** 2026-08-10 · **Proposed phases:** 36–45 (numbering provisional) · **Depends on:** v4.0 complete
