...
HIGH_PROFILE_CVES = [
    (
        ...
        10.0,
        "xz-utils",
        "Downgrade xz-utils to version 5.4.x or upgrade to 5.6.2+",
        True,
        True,
    ),
    (
        ...
        9.8,
        "FortiOS",
        "Upgrade FortiOS to 7.4.3, 7.2.7, or 7.0.14",
        True,
        True,
    ),
    (
        ...
        7.5,
        "nginx",
        "Update nginx to 1.25.3+ or apply HTTP/2 rate limiting",
        True,
        True,
    ),
    (
        ...
        "Upgrade ScreenConnect to 23.9.8+",
        True,
        True,
    ),
    (
        "CVE-2023-4966",
        "Citrix Bleed - NetScaler Information Disclosure",
        "CRITICAL",
        9.4,
        "Citrix NetScaler ADC",
        "Apply Citrix firmware update CTX579459",
        True,
        True,
    ),
    (
    ...
    (
        "CVE-2023-22518",
        "Confluence Data Center Authentication Bypass",
        "CRITICAL",
        9.8,
        "Atlassian Confluence",
        "Upgrade Confluence to 8.3.4, 8.4.4, 8.5.3, or 8.6.1",
        True,
        True,
    ),
    (
        ...
        9.8,
        "PAN-OS",
        "Apply PAN-OS hotfix or restrict management interface access",
        True,
        True,
    ),
    (
        ...
        9.8,
        "F5 BIG-IP",
        "Apply F5 hotfix or restrict access to Configuration utility",
        True,
        True,
    ),
    (
    ...
    (
        ...
        "Apply MOVEit Transfer patches and rotate credentials",
        True,
        True,
    ),
    (
        ...
        8.1,
        "OpenSSH",
        "Upgrade OpenSSH to 9.8p1+ or set LoginGraceTime to 0",
        True,
        False,
    ),
    (
    ...
    (
        ...
        10.0,
        "Cisco IOS XE",
        "Disable HTTP server feature or restrict access; apply Cisco patch",
        True,
        True,
    ),
    (
        ...
        "Apply Ivanti patches or use XML mitigation",
        True,
        True,
    ),
]
...
COMMON_CVES = [
    (
        ...
        8.8,
        "Google Chrome",
        "Update Chrome to 128.0.6613.84+",
        False,
        False,
    ),
    (
        "CVE-2024-9680",
        "Firefox Use-After-Free in Animation",
        "HIGH",
        8.8,
        "Mozilla Firefox",
        "Update Firefox to 131.0.2+",
        True,
        False,
    ),
    ...
    (
        ...
        5.9,
        "OpenSSL",
        "Update OpenSSL to 3.2.2, 3.1.6, 3.0.14",
        False,
        False,
    ),
    (
        "CVE-2024-0727",
        "OpenSSL PKCS12 NULL Dereference",
        "MEDIUM",
        5.5,
        "OpenSSL",
        "Update OpenSSL to 3.2.1, 3.1.5, 3.0.13, 1.1.1x",
        False,
        False,
    ),
    (
        "CVE-2024-3596",
        "RADIUS Protocol Forgery (Blast-RADIUS)",
        "HIGH",
        7.5,
        "FreeRADIUS",
        "Enforce Message-Authenticator attribute on all RADIUS packets",
        False,
        False,
    ),
    (
        ...
        5.9,
        "OpenSSL",
        "Update OpenSSL to 3.3.2, 3.2.3, 3.1.7, 3.0.15",
        False,
        False,
    ),
    (
        ...
        9.8,
        "Windows",
        "Apply KB5041585 cumulative update",
        True,
        False,
    ),
    (
        "CVE-2023-48795",
        "SSH Terrapin Prefix Truncation Attack",
        "MEDIUM",
        5.9,
        "OpenSSH",
        "Update SSH client/server and disable affected ciphers",
        False,
        False,
    ),
    (
        ...
        7.8,
        "Windows",
        "Apply June 2024 Patch Tuesday updates",
        True,
        False,
    ),
    (
        ...
        9.8,
        "Windows",
        "Apply August 2024 security update",
        False,
        False,
    ),
    (
    ...
    (
        ...
        "Upgrade GoAnywhere MFT to 7.4.1+",
        True,
        False,
    ),
    (
        ...
        7.5,
        "Microsoft Office",
        "Apply Microsoft security updates and enable Attack Surface Reduction rules",
        True,
        True,
    ),
    (
    ...
    (
        "CVE-2024-24576",
        "Rust std::process::Command Argument Injection on Windows",
        "CRITICAL",
        10.0,
        "Rust",
    ...
    (
        ...
        9.8,
        "Apache Struts",
        "Upgrade Apache Struts to 6.3.0.2+ or 2.5.33+",
        True,
        False,
    ),
    (
        ...
        8.3,
        "Ivanti Connect Secure",
        "Apply Ivanti XML mitigation or upgrade to patched version",
        True,
        False,
    ),
    (
        ...
        8.6,
        "Cisco ASA",
        "Apply Cisco security advisory cisco-sa-asaftd-websrvs-dos",
        True,
        True,
    ),
    (
        ...
        10.0,
        "PAN-OS",
        "Apply PAN-OS hotfix; disable GlobalProtect if not needed",
        True,
        True,
    ),
    (
    ...
    (
        ...
        9.8,
        "FortiManager",
        "Upgrade FortiManager to 7.6.1, 7.4.5, 7.2.8, or 7.0.13",
        True,
        True,
    ),
    (
        ...
        8.8,
        "Google Chrome",
        "Update Chrome to 125.0.6422.112+",
        True,
        True,
    ),
    (
        "CVE-2024-4671",
        "Chrome Visuals Use-After-Free",
        "HIGH",
        8.8,
        "Google Chrome",
        "Update Chrome to 124.0.6367.201+",
        True,
        True,
    ),
    (
        ...
        8.8,
        "Google Chrome",
        "Update Chrome to 125.0.6422.60+",
        True,
        True,
    ),
    (
        "CVE-2023-7024",
        "Chrome WebRTC Heap Buffer Overflow",
        "HIGH",
        8.8,
        "Google Chrome",
        "Update Chrome to 120.0.6099.129+",
        True,
        True,
    ),
    (
    ...
    (
        ...
        8.8,
        "Windows",
        "Apply November 2023 Patch Tuesday updates",
        True,
        True,
    ),
    (
        "CVE-2024-29988",
        "Windows SmartScreen Prompt Bypass",
        "HIGH",
        8.8,
        "Windows",
        "Apply April 2024 Patch Tuesday updates",
        True,
        False,
    ),
    (
        ...
        7.8,
        "Windows",
        "Apply March 2024 Patch Tuesday updates",
        True,
        True,
    ),
]
...
MISCONFIGURATIONS = [
    (
        ...
        "Public read access is enabled on S3 bucket",
        "STORAGE",
        "CRITICAL",
        "AWS",
        "arn:aws:s3:::prod-data-exports",
        "prod-data-exports",
        "aws_s3_bucket",
        "us-east-1",
        ["CIS", "SOC2", "PCI-DSS"],
    ...
    (
        ...
        "Inbound SSH (port 22) is open to the internet",
        "NETWORK",
        "HIGH",
        "AWS",
        "arn:aws:ec2:us-east-1:123456789012:security-group/sg-0abc123",
        "sg-web-prod",
        "aws_security_group",
        "us-east-1",
        ["CIS", "SOC2"],
    ...
    (
        ...
        "HIGH",
        "AWS",
        "arn:aws:rds:us-east-1:123456789012:db:prod-postgres",
        "prod-postgres",
        "aws_rds_instance",
        "us-east-1",
        ["CIS", "PCI-DSS"],
    ...
    (
        ...
        "Automatic key rotation is not enabled for KMS key",
        "ENCRYPTION",
        "MEDIUM",
        "AWS",
    ...
    (
        ...
        "CloudTrail logging is not enabled globally",
        "LOGGING",
        "HIGH",
        "AWS",
    ...
    (
        ...
        "us-east-1",
        ["CIS", "PCI-DSS"],
        "Restrict RDP access to VPN CIDR only",
    ),
    (
        "CIS-AZURE-3.1",
        "Storage Account Allows HTTP",
        "Azure Storage account allows unencrypted HTTP access",
        "ENCRYPTION",
        "MEDIUM",
        "AZURE",
        "/subscriptions/sub-001/resourceGroups/rg-prod/providers/Microsoft.Storage/storageAccounts/prodstore01",
        "prodstore01",
    ...
    (
        "CIS-AZURE-4.1.1",
        "Network Security Group Allows All Inbound",
        "NSG rule allows all inbound traffic",
        "NETWORK",
        "CRITICAL",
        "AZURE",
        "/subscriptions/sub-001/resourceGroups/rg-staging/providers/Microsoft.Network/networkSecurityGroups/nsg-staging",
        "nsg-staging",
        "azure_network_security_group",
        "eastus",
        ["CIS", "PCI-DSS"],
        "Remove overly permissive inbound rules from NSG",
    ),
    (
        "CIS-AZURE-1.2",
        "Azure AD User Without MFA",
        "Multiple users in Azure AD do not have MFA enabled",
        "IAM",
        "HIGH",
        "AZURE",
        "/subscriptions/sub-001/providers/Microsoft.AAD/users",
        "azure-ad-users",
        "azure_ad_user",
        "global",
        ["CIS", "SOC2", "HIPAA"],
    ...
    (
        ...
        "MEDIUM",
        "AZURE",
        "/subscriptions/sub-001/resourceGroups/rg-prod/providers/Microsoft.KeyVault/vaults/kv-prod",
        "kv-prod",
        "azure_key_vault",
        "eastus",
        ["CIS"],
    ...
    (
        "CIS-AZURE-9.1",
        "App Service Does Not Use Latest TLS",
        "App Service is not configured to use TLS 1.2+",
        "ENCRYPTION",
        "MEDIUM",
        "AZURE",
        "/subscriptions/sub-001/resourceGroups/rg-prod/providers/Microsoft.Web/sites/api-prod",
        "api-prod",
        "azure_app_service",
        "eastus",
        ["CIS", "PCI-DSS"],
        "Set minimum TLS version to 1.2 on App Service",
    ),
    (
        "CIS-GCP-3.1",
        "Default Network Exists",
        "Default VPC network still exists in project",
        "NETWORK",
        "MEDIUM",
        "GCP",
        "projects/getvul-prod/global/networks/default",
        "default-network",
        "gcp_compute_network",
        "global",
        ["CIS"],
        "Delete the default network and create custom VPC",
    ),
    (
        "CIS-GCP-1.1",
        "Service Account Key Older Than 90 Days",
        "Service account key has not been rotated",
        "IAM",
        "HIGH",
        "GCP",
        "projects/getvul-prod/serviceAccounts/sa-deploy@getvul-prod.iam.gserviceaccount.com/keys/key-001",
        "sa-deploy-key",
    ...
    (
        ...
        "GCP VM instance has an external IP address attached",
        "COMPUTE",
        "MEDIUM",
        "GCP",
        "projects/getvul-prod/zones/us-central1-a/instances/data-processor",
        "data-processor",
        "gcp_compute_instance",
        "us-central1",
        ["CIS"],
        "Remove external IP and use Cloud NAT for egress",
    ),
    (
        "CIS-GCP-6.2",
        "Compute Instance Without Shielded VM",
        "GCP VM instance does not have Shielded VM enabled",
        "COMPUTE",
        "LOW",
        "GCP",
        "projects/getvul-prod/zones/us-central1-a/instances/test-runner",
        "test-runner",
        "gcp_compute_instance",
        "us-central1",
        ["CIS"],
        "Enable Shielded VM features (Secure Boot, vTPM)",
    ),
    (
        "CIS-AWS-2.1",
        "EBS Volume Not Encrypted",
        "EBS volume attached to production instance is not encrypted",
        "ENCRYPTION",
        "HIGH",
        "AWS",
        "arn:aws:ec2:us-east-1:123456789012:volume/vol-0abc123",
        "vol-prod-data",
        "aws_ebs_volume",
        "us-east-1",
        ["CIS", "HIPAA", "PCI-DSS"],
        "Enable default EBS encryption and re-create unencrypted volumes",
    ),
    (
        "CIS-AWS-1.16",
        "IAM Policy Allows Full Admin Access",
        "IAM policy attached to role grants *:* permissions",
        "IAM",
        "CRITICAL",
        "AWS",
        "arn:aws:iam::123456789012:policy/LegacyAdminPolicy",
        "LegacyAdminPolicy",
        "aws_iam_policy",
        "global",
        ["CIS", "SOC2"],
    ...
    (
        ...
        "CRITICAL",
        "GCP",
        "projects/getvul-prod/instances/analytics-db",
        "analytics-db",
        "gcp_sql_instance",
        "us-central1",
        ["CIS", "PCI-DSS"],
    ...
    (
        ...
        "HIGH",
        "AZURE",
        "/subscriptions/sub-001/resourceGroups/rg-prod/providers/Microsoft.Sql/servers/sql-prod",
        "sql-prod",
        "azure_sql_server",
        "eastus",
        ["CIS", "SOC2", "HIPAA"],
        "Enable auditing on Azure SQL Server",
    ),
]
...
NOTIFICATIONS = [
    (
        "Critical Vulnerability: CVE-2024-3094 (XZ Backdoor)",
        "A critical backdoor vulnerability was detected in xz-utils on 3 assets. Immediate patching required.",
        "critical",
        "new_critical_vuln",
        False,
    ),
    (
        "SLA Breach: 5 HIGH vulns overdue on SRV-WEB-01",
        "5 HIGH severity vulnerabilities have exceeded their 30-day SLA on server SRV-WEB-01.",
        "high",
        "sla_breach",
        False,
    ),
    (
        "Sync Complete: CrowdStrike",
        "CrowdStrike Spotlight sync completed successfully. 87 vulnerabilities ingested across 18 assets.",
        "medium",
        "sync_complete",
        True,
    ),
    (
        "Risk Score Spike: SRV-DB-01 (45 -> 92)",
        "Server SRV-DB-01 risk score increased from 45 to 92 after new critical vulnerabilities were detected.",
        "high",
        "risk_spike",
        False,
    ),
    (
        "SLA Breach: 2 CRITICAL vulns overdue on FW-EDGE-01",
        "2 CRITICAL severity vulnerabilities have exceeded their 7-day SLA on firewall FW-EDGE-01.",
        "critical",
        "sla_breach",
        True,
    ),
...
async def seed() -> None:
    async with async_session_factory() as session:
        ...
        assignees = [
            "jchen@demo.getvul.local",
            "slee@demo.getvul.local",
            "amartin@demo.getvul.local",
            "rpatel@demo.getvul.local",
            "ljones@demo.getvul.local",
        ]
        ticket_count = 0
